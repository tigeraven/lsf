...
elseif (is_search()) : ?>
    ...
    <div class="loop-meta">
        ...
        <div class="loop-description">
            <p>
                <?php printf(wp_kses_post(__('You are browsing the search results for &quot;%1$s&quot;', 'peak')), esc_attr(get_search_query())); ?>
            </p>
        </div>
        <!-- .loop-description -->
...
elseif (is_date()) : ?>
    ...
    <div class="loop-meta">
        <h1 class="loop-title"><?php esc_html_e('Archives for ' . mo_get_date_text(), 'peak'); ?></h1>

        <div class="loop-description">
            <p>
                <?php esc_html_e('You are browsing the site archives by date.', 'peak'); ?>
            </p>
        </div>
        <!-- .loop-description -->
...
elseif (is_archive()) : ?>
    ...
    <div class="loop-meta">
        ...
        <h1 class="loop-title"><?php esc_html_e('Archives', 'peak'); ?></h1>

        <div class="loop-description">
            <p>
                <?php esc_html_e('You are browsing the site archives.', 'peak'); ?>
            </p>
        </div>
        <!-- .loop-description -->
...
<?php
elseif (is_page_template('template-popular-posts.php')) : ?>

    <div class="loop-meta">

        <h1 class="loop-title"><?php esc_html_e('Most Popular', 'peak'); ?></h1>

        <div class="loop-description">
            <p>
                <?php esc_html_e('You are browsing the site archives by popularity.', 'peak'); ?>
            </p>
        </div>
        <!-- .loop-description -->
