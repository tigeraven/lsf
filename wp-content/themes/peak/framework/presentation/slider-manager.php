    ...
    class MO_Slider_Manager {
        ...
        function display_revolution_slider() {
            ...
            if (!empty($chosen_slider) && $chosen_slider !== 'none') {
                ...
                echo do_shortcode('[segment id="slider-error"]' . esc_html__('Revolution Slider Plugin Not Installed/Deactivated or No Revolution Slider entries created. Prepare the Revolution Slider or choose a different slider type in theme options', 'peak') . '[/segment]');
            }
        }
