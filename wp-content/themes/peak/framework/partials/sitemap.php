...
if (!function_exists('mo_sitemap_template')) {
    ...
    function mo_sitemap_template() {
        ...
        <div class="fourcol">
            ...
            <h2 id="posts"><?php echo esc_html__('Posts by Category', 'peak'); ?></h2>
        ...
        <div class="fourcol">
            ...
            <h2 id="pages"><?php echo esc_html__('Pages', 'peak'); ?></h2>
        ...
        <div class="fourcol last">
            ...
            <h2 id="authors"> <?php echo esc_html__('Authors', 'peak'); ?></h2>
            ...
            <h2 id="portfolio"><?php echo esc_html__('Our Portfolio', 'peak'); ?></h2>
