...
function mo_divider_shortcode($atts, $content = null, $shortcode_name = "") {
    ...
    return '<div class="' . str_replace('_', '-', $shortcode_name) . '"' . ($style ? (' style="' . esc_attr($style) . '"') : '') . '></div>';
}
...
function mo_header_shortcode($atts, $content = null, $shortcode_name = "") {
    ...
    return '<div class="' . str_replace('_', '-', $shortcode_name) . ' ' . esc_attr($class) . '"' . ($style ? (' style="' . esc_attr($style) . '"') : '') . '><span>' . esc_html($title) . '</span></div>';
}
