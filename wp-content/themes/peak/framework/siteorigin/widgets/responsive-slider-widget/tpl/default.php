...
$shortcode = '[responsive_slider style="' . $style . '" type="' . ($type ? $type : 'flex') . '" animation="' . $animation . '" control_nav="' . ($control_nav ? 'true' : 'false') . '" direction_nav="' . ($direction_nav ? 'true' : 'false') . '" pause_on_hover="' . ($pause_on_hover ? 'true' : 'false') . '" pause_on_action="' . ($pause_on_action ? 'true' : 'false') . '" loop="' . ($loop ? 'true' : 'false') . '" slideshow="' . ($slideshow ? 'true' : 'false') . '" slideshow_speed="' . $slideshow_speed . '" animation_speed="' . $animation_speed . '" ]';
